...
import { handleDebugResponse } from './handlers/debug'
...
export const startConsuming = () => {
  ...
  const debugTopicsHandlers = {
    [DEBUG_RESPONSE]: handleDebugResponse,
  }
  ...
  processMessageFromQueue(config.debugResultQueue, debugTopicsHandlers)
}
